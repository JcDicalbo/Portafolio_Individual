...
const habilidades = ref([
    {// Se crea un objeto con id, nombre y habilidades
        id: 1, nombre: 'Lenguajes de Programación', habilidades: [
            ...
            { id: 1, nombre: 'JavaScript', nivel: 'En formación', icono: img1 },
            { id: 2, nombre: 'Python', nivel: 'En formación', icono: img2 },
            { id: 3, nombre: 'HTML/CSS', nivel: 'En formación', icono: img3 },
            { id: 4, nombre: 'Java', nivel: 'En formación', icono: img4 },
        ]
    },
    {
        id: 2, nombre: 'Frameworks y Librerías', habilidades: [
            { id: 1, nombre: 'Vue.js', nivel: 'En formación', icono: img7 },
            { id: 2, nombre: 'Node.js', nivel: 'En formación', icono: img8 },

        ]
    },
    {
        id: 3, nombre: 'Herramientas y Software', habilidades: [
            { id: 1, nombre: 'Git', nivel: 'En formación', icono: img11 },
            { id: 2, nombre: 'Visual Studio Code', nivel: 'En formación', icono: img15 }
        ]
    },
    {
        id: 4, nombre: 'Bases de Datos', habilidades: [
            { id: 1, nombre: 'MySQL', nivel: 'En formación', icono: img17 },
        ]
    },
    {
...
.skills-contenedor {
    ...
    /*Fondo con gradiente*/
    background: linear-gradient(-45deg, #04345e, #2271B3, #6EACDA, #ffffff5e);
...
.skill {
    ...
    padding: 0.3em;
    border-radius: 8px;
    box-shadow: 0px 4px 12px rgba(255, 255, 255, 0.963);
    flex: 1 1 200px;
    max-width: 250px;
}
