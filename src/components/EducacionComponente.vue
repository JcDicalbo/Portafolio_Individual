...
const educacion = ref([
  {fecha: '2024', title: 'Técnicatura Universitaria en Programacion', descripcion: 'Actualmente estoy cursando el primer año de la tecnicatura de programación.', enlace:'https://www.youtube.com/'},
  {fecha: '2023', title: 'Técnico en Tecnicatura de los Alimetos', descripcion: 'Estudie en el secundario técnico Escuela 4-004 Mercedes Alvarez de Segura, donde recibi mi titulo de Técnico en Alimentos', enlace:'http:www.direccion.com'},
]);
</script>
...
body {
  --color: rgb(58, 19, 19); /* Variable para el color de texto */
  --bgColor: rgb(240, 59, 59); /* Variable para el color de fondo */
...
ul::before {
  ...
  background: rgb(255, 255, 255); /* Color de la línea */
...
ul li .fecha {
  ...
  color: rgb(255, 255, 255); /* Color del texto en la fecha */
...
ul li .fecha::before {
  ...
  background-image: linear-gradient(rgba(234, 0, 255, 0.2) 100%, transparent); /* Aplica un degradado sutil para dar un efecto de sombra */
